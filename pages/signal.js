  ...
  return (
    <div className="pageContainer">
      <div className="text">
        ...
        <br />
        <br />
         We would like to thank German Sierra, Daymian Snowden, Logan Berry, William Watson, Danika Stegeman LeMay, Michael and Adrienne Gower, Chase P-G, and Alec Vohnoutka for their support as material witnesses to the mass beneath the cloak.
        </p>
