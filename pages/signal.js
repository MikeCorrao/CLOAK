  ...
  return (
    <div className={styles.signalText}>
      ...
      <p>
        ...
        document its environment—looking back as it is looked upon. Articulating
        a multi-directionality within the acts of READING & VIEWING.
      </p>

      <p>
        The CLOAK is an anti-solarist tool. Its creation is distinctly digital.
        The text is written on a computer. In Word, Google Drive, Notepad. Its
        shape is arranged on InDesign, PowerPoint, Rhino. Its body is produced
        by IngramSpark, KDP, BookMobile.
      </p>
      <a href="">
